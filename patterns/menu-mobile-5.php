...
/**
 * Title: Mobile Menu 5
 * Slug: icts-europe/mobile-menu-5
 * Description: 
...
<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Collections', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Workflows', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Analytics', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Marketplace', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-small-font-size" style="text-transform:uppercase"><strong><?php esc_html_e( 'Company', 'icts-europe' ); ?></strong></p>
<!-- /wp:paragraph -->
...
<p class="has-base-font-size"><?php esc_html_e( 'Blog', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e( 'Customers', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase"}},"fontSize":"small"} -->
<p class="has-small-font-size" style="text-transform:uppercase"><strong><?php esc_html_e( 'Resources', 'icts-europe' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:group {"metadata":{"name":"Links"},"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"base"} -->
<p class="has-base-font-size"><?php esc_html_e( 'Docs', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e( 'Press', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Developers', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Get Started Today', 'icts-europe' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-x-small-font-size"><?php esc_html_e( 'We\'re hiring! Join our growing team today.', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
