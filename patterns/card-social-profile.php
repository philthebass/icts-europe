 ...
 * Slug: icts-europe/social-profile-card
 * Description: 
...
<div class="wp-block-group"><!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"base","fontSize":"base"} -->
<p class="has-text-align-center has-base-color has-text-color has-base-font-size" style="font-style:normal;font-weight:600"><?php esc_html_e( 'Eric Voyager', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center","textColor":"tertiary"} -->
<p class="has-text-align-center has-tertiary-color has-text-color"><?php esc_html_e( 'Creator and Product Director at IdeaFlow', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<p class="has-text-align-center has-secondary-color has-text-color"><?php esc_html_e( 'Use this profile box as a LinkTree alternative. Link your social media accounts to this page so your followers can find all of your important links.', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->
