...
<p><strong><?php esc_html_e( 'Quick Resources', 'icts-europe' ); ?></strong></p>
<!-- /wp:paragraph -->
...
<p><?php esc_html_e( 'Projects', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Templates', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Team', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Integrations', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e( 'FAQs', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"width":75,"className":"is-style-secondary-button"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-75 is-style-secondary-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Browse All', 'icts-europe' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<div class="wp-block-column" style="border-radius:10px;padding-top:var(--wp--preset--spacing--medium);padding-right:0;padding-bottom:var(--wp--preset--spacing--medium);padding-left:0"><!-- wp:paragraph -->
<p><strong><?php esc_html_e( 'Learn Our Product', 'icts-europe' ); ?></strong></p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"metadata":{"name":"Links"},"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph -->
<p><?php esc_html_e( 'Documentation', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Playground', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Dashboard', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Community', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Enterprise', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Marketplace', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-base-font-size"><strong><?php esc_html_e( 'Success Stories', 'icts-europe' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size"><?php esc_html_e( 'See how companies like yours increased productivity by 40% overnight.', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"width":100,"className":"icts-europe-no-shrink is-style-button-light"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100 icts-europe-no-shrink is-style-button-light"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Start Free Trial', 'icts-europe' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
