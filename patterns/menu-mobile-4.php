...
/**
 * Title: Mobile Menu 4
 * Slug: icts-europe/mobile-menu-4
 * Description: 
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link has-x-small-font-size has-custom-font-size wp-element-button"><?php esc_html_e( 'Get Started Today', 'icts-europe' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-base-font-size"><?php esc_html_e( 'hello@example.com', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'support@example.com', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
