...
<p class="has-main-accent-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e( 'Start Designing', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-main-accent-color has-text-color"><?php esc_html_e( 'ICTS Europe ships with a growing collection of design patterns that cohesively click together. Drag, drop, mix, and match patterns to create stunning designs in just a few minutes.', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-main-accent-color has-text-color has-x-small-font-size"><?php esc_html_e( 'The WordPress Site Editor is a total game changer. It\'s blazing fast and I don\'t need a page builder anymore. 😍', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-base-color has-text-color has-medium-font-size" style="font-style:normal;font-weight:600"><?php esc_html_e( 'Theme Details', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->
