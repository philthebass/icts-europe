...
/**
 * Title: Page Centered
 * Slug: icts-europe/template-page-centered
 * Template Types: page
...
<!-- wp:group {"tagName":"main","align":"wide","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large"}}},"layout":{"type":"default"}} -->
