 ...
 * Slug: icts-europe/hero-call-to-action-buttons
 * Description:
...
<h2 class="wp-block-heading has-text-align-center has-secondary-font-family has-x-large-font-size"><?php esc_html_e( 'Design faster and publish sooner with ICTS Europe', 'icts-europe' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-button-brand"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Download ICTS Europe', 'icts-europe' ); ?></a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-button-light"} -->
<div class="wp-block-button is-style-button-light"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'ICTS Europe Features', 'icts-europe' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div></div>
