...
<p class="has-small-font-size"><?php esc_html_e( 'Easily create beautiful, fully-customizable websites with the new WordPress Site Editor and the ICTS Europe block theme. No coding skills required. Download for free today!', 'icts-europe' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-small-font-size"><?php esc_html_e( '© 2025', 'icts-europe' ); ?><strong><?php esc_html_e( '·', 'icts-europe' ); ?></strong><?php esc_html_e( '&nbsp;Powered by WordPress and ', 'icts-europe' ); ?><a href="https://icts-europewp.com"><?php esc_html_e( 'ICTS Europe', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph -->
