...
/**
 * Title: Mobile Menu 3
 * Slug: icts-europe/mobile-menu-3
 * Description: 
...
<p class="has-base-font-size"><strong><?php esc_html_e( 'Margo Middleton', 'icts-europe' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"textColor":"secondary"} -->
<p class="has-secondary-color has-text-color has-link-color"><?php esc_html_e( 'Director of AI', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"metadata":{"name":"Section"},"style":{"spacing":{"padding":{"right":"var:preset|spacing|medium","left":"var:preset|spacing|medium","top":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium"},"blockGap":"var:preset|spacing|small"}},"fontSize":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-base-font-size" style="padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'Pre-designed Patterns', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Built for the Future', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Easy to Extend', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Developer Friendly', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><a href="#"></a><a href="#"><?php esc_html_e( 'Publish Faster', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-secondary-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'Check out my new podcast, VectorAI.', 'icts-europe' ); ?><a href="#"><?php esc_html_e( 'Learn more', 'icts-europe' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
