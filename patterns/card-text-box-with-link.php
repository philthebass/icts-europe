...
/**
 * Title: Text Box Card
 * Slug: icts-europe/text-box-with-link-card
 * Description: 
...
<p class="has-secondary-color has-text-color"><?php esc_html_e( 'Add your splash of colors, pick your header, choose your favorite font — all with a few quick clicks. No coding skills required.', 'icts-europe' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
