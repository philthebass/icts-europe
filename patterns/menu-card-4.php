...
<!-- wp:buttons {"className":"icts-europe-no-shrink"} -->
<div class="wp-block-buttons icts-europe-no-shrink"><!-- wp:button {"className":"is-style-secondary-button"} -->
<div class="wp-block-button is-style-secondary-button"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Read More', 'icts-europe' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:group {"metadata":{"name":"Text"},"style":{"spacing":{"blockGap":"5px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"base"} -->
<p class="has-base-font-size"><strong><strong><?php esc_html_e( 'Version Control', 'icts-europe' ); ?></strong></strong></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:group {"metadata":{"name":"Text"},"style":{"spacing":{"blockGap":"5px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"base"} -->
<p class="has-base-font-size"><strong><strong><?php esc_html_e( 'Team Comments', 'icts-europe' ); ?></strong></strong></p>
<!-- /wp:paragraph -->
